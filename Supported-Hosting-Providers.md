...
* [PloudOS](https://ploudos.com/) (Connect via `geyser.ploudos.com` and enter the server IP with you Java IP and port. See [PloudOS's article](https://ploudos.com/faq/#How-do-I-connect-from-Bedrock-to-a-Java-server) for more details.)
