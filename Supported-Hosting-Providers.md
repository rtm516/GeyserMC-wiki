...
* [Clovux](https://clovux.net/) (Get Geyser as a plugin. Use the same port as your Java server for the Bedrock port in your config and connect with that port. Make sure your remote addres is 'auto' and your bedrock address is your server IP.)
...
* [WitherHosting](https://witherhosting.com/) (Get Geyser as a plugin. If you don't have a dedicated IP, use the same port as your Java server for the Bedrock port in your config and connect with that port.)
