This list is incomplete. Please add a link or contact us via [Discord](http://discord.geysermc.org).
You can also edit if the information is incorrect or you want to add a new hosting provider!
...
* [FastLogin](https://www.spigotmc.org/resources/fastlogin.14153/) does not let floodgate add player prefix. ~~Latest dev versions seemed to include supports, but it's at the moment yet unverified.~~
